/** 
    ...
    This library (a.k.a. The Removers Library) is intended to help
    programmers to write cool games for the <a
    href="http://en.wikipedia.org/wiki/Atari_Jaguar">Atari Jaguar</a>.
